...
const MARKET_PRODUCTS = [
  ...
  { query: 'over ear headphones',    label: 'Over-Ear Headphones',    category: 'Electronics', jijiPath: '/electronics' },
  ...
  { query: 'nintendo switch',        label: 'Nintendo Switch',        category: 'Electronics', jijiPath: '/electronics' },
  ...
  { query: 'ip camera wifi',         label: 'IP Camera (WiFi)',        category: 'Electronics', jijiPath: '/electronics' },
  ...
  { query: 'ups battery backup',     label: 'UPS Battery Backup',     category: 'Electronics', jijiPath: '/electronics' },
  ...
  { query: 'lithium solar battery',  label: 'Lithium Solar Battery',  category: 'Electronics', jijiPath: '/electronics' },
  { query: 'inverter battery pack',  label: 'Inverter / Battery Pack',category: 'Electronics', jijiPath: '/electronics' },
  { query: 'access control system',  label: 'Access Control System',  category: 'Electronics', jijiPath: '/electronics' },
  { query: 'biometric device',       label: 'Biometric Device',       category: 'Electronics', jijiPath: '/electronics' },
  ...
  { query: 'toyota land cruiser prado', label: 'Toyota Land Cruiser Prado', category: 'Vehicles', jijiPath: '/cars' },
  ...
  { query: 'toyota chr',             label: 'Toyota C-HR',            category: 'Vehicles', jijiPath: '/cars' },
  ...
  { query: 'hyundai h1 starex',      label: 'Hyundai H1 / Starex',    category: 'Vehicles', jijiPath: '/cars' },
  ...
  { query: 'nissan x-trail',         label: 'Nissan X-Trail',         category: 'Vehicles', jijiPath: '/cars' },
  ...
  { query: 'air filter car',         label: 'Air Filter',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'windscreen windshield',  label: 'Windscreen / Windshield',category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'shock absorber',         label: 'Shock Absorber',         category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'tie rod end',            label: 'Tie Rod End',            category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'android car radio',      label: 'Android Car Radio',      category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'ignition coil',          label: 'Ignition Coil',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'brake pads',             label: 'Brake Pads',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car radiator',           label: 'Car Radiator',           category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'transmission fluid',     label: 'Transmission Fluid',     category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'steering rack',          label: 'Steering Rack',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'fuel pump car',          label: 'Fuel Pump',              category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'brake disc rotor',       label: 'Brake Disc',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'suspension arm',         label: 'Suspension Arm',         category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car cover dust',         label: 'Car Cover (Dust)',       category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'oil filter car',         label: 'Oil Filter',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'alternator car',         label: 'Alternator',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'reverse camera car',     label: 'Reverse Camera',         category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'alloy rim wheel',        label: 'Alloy Rim / Wheel',      category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'power steering pump',    label: 'Power Steering Pump',    category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'wheel bearing',          label: 'Wheel Bearing',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'dash camera dashcam',    label: 'Dash Camera',            category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'engine mount',           label: 'Engine Mount',           category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car jack',               label: 'Car Jack',               category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'starter motor car',      label: 'Starter Motor',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car seat cover',         label: 'Car Seat Cover',         category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'gearbox transmission',   label: 'Gearbox',                category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'mass airflow sensor',    label: 'Mass Airflow Sensor',    category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'motorcycle battery',     label: 'Motorcycle Battery',     category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car charger inverter',   label: 'Car Charger / Inverter', category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'spark plug',             label: 'Spark Plug',             category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car door panel',         label: 'Car Door Panel',         category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'oxygen lambda sensor',   label: 'Oxygen / Lambda Sensor', category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'motorcycle engine',      label: 'Motorcycle Engine',      category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car battery charger',    label: 'Car Battery Charger',    category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'exhaust pipe car',       label: 'Exhaust Pipe',           category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'side mirror car',        label: 'Side Mirror',            category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'catalytic converter',    label: 'Catalytic Converter',    category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car gps tracker',        label: 'Car GPS Tracker',        category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'coolant antifreeze',     label: 'Coolant / Antifreeze',   category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'fan belt drive belt',    label: 'Fan Belt / Drive Belt',  category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car floor mat',          label: 'Car Floor Mat',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car headlight',          label: 'Car Headlight',          category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car bonnet hood',        label: 'Car Bonnet / Hood',      category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car tyre 235',           label: 'Car Tyre 235/55',        category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  { query: 'car alarm system',       label: 'Car Alarm System',       category: 'Vehicle Parts', jijiPath: '/vehicle-parts' },
  ...
  { query: 'clothes dryer',           label: 'Clothes Dryer',              category: 'Appliances', jijiPath: '/home-appliances' },
  ...
  { query: 'cassette ac ceiling',     label: 'Cassette AC (Ceiling)',      category: 'Appliances', jijiPath: '/home-appliances' },
  ...
  { query: 'wine cooler bar fridge',  label: 'Wine Cooler / Bar Fridge',   category: 'Appliances', jijiPath: '/home-appliances' },
  ...
  { query: 'stand mixer',             label: 'Stand Mixer',                category: 'Appliances', jijiPath: '/home-appliances' },
  ...
  { query: 'back massager',           label: 'Back Massager',              category: 'Appliances', jijiPath: '/home-appliances' },
  ...
  { query: 'multivitamins',           label: 'Multivitamins',              category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'wheelchair',              label: 'Wheelchair',                 category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'pulse oximeter',          label: 'Pulse Oximeter',             category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'oxygen concentrator',     label: 'Oxygen Concentrator',        category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'glucose test strips',     label: 'Glucose Test Strips',        category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'glucometer',              label: 'Glucometer',                 category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'hearing aid',             label: 'Hearing Aid',                category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'face mask box',           label: 'Face Mask (Box)',            category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'hair loss treatment',     label: 'Hair Loss Treatment',        category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'surgical gloves box',     label: 'Surgical Gloves (Box)',      category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'digital thermometer',     label: 'Digital Thermometer',        category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'pregnancy test kit',      label: 'Pregnancy Test Kit',         category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'protein supplement',      label: 'Protein Supplement',         category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'dental equipment',        label: 'Dental Equipment',           category: 'Health & Medical', jijiPath: '/ghana' },
  { query: 'blood pressure monitor',  label: 'Blood Pressure Monitor',     category: 'Health & Medical', jijiPath: '/ghana' },
  ...
  { query: 'wall putty skimcoat',     label: 'Wall Putty / Skimcoat',      category: 'Building Materials', jijiPath: '/building-materials' },
  ...
  { query: 'stone coated roof tile',  label: 'Stone Coated Roof Tile',     category: 'Building Materials', jijiPath: '/building-materials' },
  ...
  { query: 'sliding glass door',      label: 'Sliding Glass Door',         category: 'Building Materials', jijiPath: '/building-materials' },
  ...
  { query: 'glass wool insulation',   label: 'Glass Wool',                 category: 'Building Materials', jijiPath: '/building-materials' },
  { query: 'pop plaster ceiling',     label: 'POP / Plaster',              category: 'Building Materials', jijiPath: '/building-materials' },
  ...
  { query: 'cement',                  label: 'Cement (Generic)',           category: 'Building Materials', jijiPath: '/building-materials' },
